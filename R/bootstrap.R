...
#' 
#' ## Specify a user-defined function that takes a numeric vector input and returns a numeric result
#' sort_and_rank <- function( z, rank ){
#'   z <- sort( z )
#'   return( z[rank] )
#' }
#' 
#' ex4 <- bootstrap( x, FUN = sort_and_rank, arglist = list( rank = 1 ), varname = "response", n_samples = 2 )
